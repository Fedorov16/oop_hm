            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="t_row">
                        ...
                        <?php } ?>
                        <a href="javascript:void(0)" data-modal="<?= $user_id?>"  id="icon_setting_link" onclick="adminEditUser(<?= $user_id?>)"><ion-icon name="hammer-outline" class="icon_admin" id="icon_setting"></ion-icon></a>
                    </td>
                </tr>
                <?php } ?> 
            </tbody>
